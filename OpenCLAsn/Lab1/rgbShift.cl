...
__kernel void rgbShift(
	...
	float2 fragCoord = { position.x / 512.0f, position.y / 512.0f };
	...
	rCoords.x = min(511.0f, rCoords.x * 512.0f);
	rCoords.y = min(511.0f, rCoords.y * 512.0f);
	...
	gCoords.x = min(511.0f, gCoords.x * 512.0f);
	gCoords.y = min(511.0f, gCoords.y * 512.0f);
	...
	bCoords.x = min(511.0f, bCoords.x * 512.0f);
	bCoords.y = min(511.0f, bCoords.y * 512.0f);
